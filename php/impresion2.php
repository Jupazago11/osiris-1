...
/*
$consulta = mysqli_query($conexion, "SELECT cliente.nombre_cliente, cliente.identificacion_cliente, cliente.telefono_cliente, cliente.direccion_cliente, ubicacion.ubicacion 
FROM `factura`
INNER JOIN cliente ON cliente.id_cliente = factura.id_cliente3
INNER JOIN ubicacion ON ubicacion.id_ubi = cliente.id_ubi1
WHERE factura.id_facturacion = 1") or die ("Error al consultar: no se obtuvo la identificacion del usuario");
...
?>
    ...
    <div style="text-transform: uppercase;font-size:0.8em">
        <br>
        <br>
        cliente:&nbsp;&nbsp;&nbsp;<span><?php echo $fila['nombre_cliente'] ?></span>
        <br>
        Cedula de ciudadanía:&nbsp;<span><?php echo $fila['identificacion_cliente'] ?></span>
        <br>
        telefono:&nbsp;&nbsp;&nbsp;<span><?php echo $fila['telefono_cliente'] ?></span>
        <br>
        ubicacion:&nbsp;<span><?php echo $fila['ubicacion'] ?></span>
        <br>
        direccion:&nbsp;&nbsp;<span><?php echo $fila['direccion_cliente'] ?></span>
        <br>
        <br>
    </div>
<?php
