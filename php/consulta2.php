...
<?php
    ...
    if($existe_proveedor == true && $nombre_prove != 'FruVer'){
        ?>
        <br>
        <fieldset>
        ...
        <legend>Crear Pedido</legend>
            <table border="1" id="tabla_sugerido" width="100%">
                    ...
                    <br><br>
                    <button type="button" id="enviar2_2" class="w3-btn w3-teal" onclick="document.getElementById('respuesta2_2').style.display='block'">Registrar</button><br><br>
                    <input type="reset" value="Limpiar" class="w3-btn w3-teal" onclick="document.getElementById('respuesta2_2').style.display='none'">
                </fieldset>
            </form>
